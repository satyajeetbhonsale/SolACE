# -*- coding: utf-8 -*-
"""
Created on Thu Oct  1 13:51:48 2015
...
MPC = MPCproblem(1000,total_plant=3000)
...
MPC.addMeasurementNoise([2,3],[5,5])
#### ESTIMATOR
sigma_y = NP.array([5,5])
V = (sigma_y**2) * NP.eye(2)
sigma_x0 = 0.05
P00 = (sigma_x0**2) * NP.eye(4)
est = Estimator('ekf',[2,3],V,P00)

x2 = est.addStates(4,[0.0,0.0,50.0,50.0,-1.0e06],[10.0,10.0,250.0,250.0,1.0e06],[2.14,1.09,114.2,112.9,0.0])
